        ...
        <div class="auction">
            ...
            <div class="nft">
                <div class=item>
                    ...
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px;" button id="EcoNatura" onclick="FashionFusionHQSuma()">
                ...
                <div class=item>
                    ...
                    <!-- Apartado de añadir al carrito -->
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px; bor" button id="TechGizmos" onclick="MindfulMeditatorSuma()">
                        <span class="default">Añadir a la cesta</span>
                        <span class="success">
                            Exito
                            <svg viewbox="0 0 12 10">
                ...
                <div class=item>
                    ...
                    <!-- Apartado de añadir al carrito -->
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px; bor" button id="HealthyLivingHub" onclick="CulinaryCraftsmenSuma()">
                        <span class="default">Añadir a la cesta</span>
                        <span class="success">
                            Exito
                            <svg viewbox="0 0 12 10">
                ...
                <div class=item>
                    ...
                    <!-- Apartado de añadir al carrito -->
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px; bor" button id="TravelVoyagePro" onclick="ArtisanCraftersSuma()">
                        <span class="default">Añadir a la cesta</span>
                        <span class="success">
                            Exito
                            <svg viewbox="0 0 12 10">
